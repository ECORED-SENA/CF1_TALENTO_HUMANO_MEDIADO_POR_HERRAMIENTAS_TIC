  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Determinar el sector y la actividad económica correspondiente a las empresas seleccionadas.
        .tarjeta.tarjeta--piel.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 Identificar sector y actividad económica de las empresas.
            .col-auto
